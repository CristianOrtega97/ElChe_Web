...
<body>
    ...
    <div class="david_pop-up" id="vent-prom">
           ...
           <h3>Reservación Habitación Sencilla</h3><br>
           <div>
                <form action="gracias_reserva.php" method="get">
                    ...
                    Correo contacto: <input type="email" name="email" placeholder="email"><br>
        ...
        <div class="david_pop-up" id="vent-prom-2">
            ...
            <h3>Reservación Habitación Doble</h3><br>
            <div>
                <form action="gracias_reserva.php" method="get">
        ...
        <div class="david_pop-up" id="vent-prom-3">
            ...
            <h3>Reservación Habitación Jr. Suite</h3><br>
            <div>
                <form action="gracias_reserva.php" method="get">
        ...
        <div class="david_pop-up" id="vent-prom-4">
            ...
            <h3>Reservación Habitación Suite</h3><br>
            <div>
                <form action="gracias_reserva.php" method="get">
